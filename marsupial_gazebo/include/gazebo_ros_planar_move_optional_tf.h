...
#ifndef GAZEBO_ROS_PLANAR_MOVE_OPTIONAL_TF_HH
#define GAZEBO_ROS_PLANAR_MOVE_OPTIONAL_TF_HH
...
namespace gazebo {
  ...
  class GazeboRosPlanarMove : public ModelPlugin {
    ...
    private:
      ...
      std::vector<std::string> v_robot_base_frame_;
      ...
      double cmd_timeout_;
      bool publish_odom_tf_, marsupial_configuration_;
